...
use crate::{
    AgentAttachment, AgentTaskSummary, DownloadedAttachment, ReadError, ReadableAttachment,
    ReadableAttachmentContentFormat, ReadableAttachmentSourceKind,
};

#[derive(Debug)]
pub(super) struct ResolvedTaskAttachmentDownload {
    pub(super) attachment: AgentAttachment,
    pub(super) blob_ref: AttachmentBlobRef,
    pub(super) download: DownloadAttachmentResponse,
}

#[derive(Debug, Clone, Copy, Eq, PartialEq)]
pub(super) enum AttachmentReadStrategy {
    Utf8Text,
    DocxMarkdown,
    Unsupported,
}
...
impl AgentAttachment {
    ...
    #[must_use]
    pub(super) fn read_strategy(&self) -> AttachmentReadStrategy {
...
pub(super) fn find_task_attachment(
...
pub(super) async fn download_and_decrypt_attachment(
...
pub(super) fn build_readable_attachment(
...
pub(super) fn unsupported_attachment_read_error(file_name: &str) -> PublicError {
